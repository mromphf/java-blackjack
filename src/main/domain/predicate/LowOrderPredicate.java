...
public class LowOrderPredicate {
    ...
    public static final Predicate<Snapshot> handsRemainToBePlayed = snapshot -> !snapshot.getHandsToPlay().isEmpty();

    public static final Predicate<Snapshot> noActionsTaken = snapshot -> snapshot.getActionsTaken().isEmpty();

    public static final Predicate<Snapshot> handsRemainToBeSettled = snapshot -> !snapshot.getHandsToSettle().isEmpty();

    public static final Predicate<Snapshot> playerHasBusted = snapshot -> isBust(snapshot.getPlayerHand());
